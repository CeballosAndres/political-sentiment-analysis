class bs4Toast {
    ...
    static show(title = '', content = '', options = {}) {
        ...
        headerWrapper.classList.add("d-flex");
        headerWrapper.classList.add("align-items-center");
        headerWrapper.classList.add("justify-content-between");
        ...
        headerWrapper.setAttribute('style','padding-left:10px; padding-right:10px;')
        ...
        closeButton.classList.add("border-0");
        closeButton.setAttribute('onclick','eliminar(this.parentNode.parentNode.id)')
        closeButton.classList.add("bg-transparent");
